import { ethers } from '../hardhat/node_modules/ethers/dist/ethers.min.js';
import { contractAddress, SimpleStorageABIJSON } from './constant.js';
...
connectButton.addEventListener('click', async function() {
    if(typeof window.ethereum !== 'undefined') {
        ...
        connectedAccount = await ethers.utils.getAddress(resultAccount[0])
...
getNumber.addEventListener('click', async function() {
    if(typeof window.ethereum !== "undefined" && connectedAccount) {
        try {
            ...
            const contract = new ethers.Contract(contractAddress, SimpleStorageABIJSON, provider)
